...
shinyApp(
  ui = dashboardPage(
    ...
    footer = bs4DashFooter(
      ...
      left = a(
        target = "_blank",
        HTML(paste0(a(img(src='lepida_logo_viola.svg',height='35'),href="https://www.lepida.net/",target = "_blank",id = "logo1"), "&nbsp;", "&nbsp;",
                    a(img(src='ARPAE.svg',height='35'),href="https://www.arpae.it/it",target = "_blank",id = "logo2"), "&nbsp;", "&nbsp;",
                    a(img(src='logo_RER.jpg',height='35'),href="https://www.regione.emilia-romagna.it/",target = "_blank",id = "logo3"), "&nbsp;", "&nbsp;",
                    img(src='Loghi_CoesioneITA_UE_REP_ER_21-27_compatta_colore.jpg',height='35')
                    # tags$div(
                    #   tags$img(src = "Loghi_CoesioneITA_UE_REP_ER_21-27_compatta_colore.jpg", height = "35px"),
      ...
      right = a(
        target = "_blank",
        HTML(paste0("Sviluppato da:&nbsp;",a(img(src='logo_Terraria_Ridimensionato.png',height='35'),href="https://www.terraria.com",target = "_blank",id = "logo4")))
      ),
      fixed = TRUE
  ...
  server = function(input, output, session) {
    ...
    notAuthorized <- reactiveVal(TRUE)
    ...
    output$main_ui <- renderUI({
      ...
      print(paste0(Sys.time(), " - notAuthorized: ", notAuthorized()))
      
      if (notAuthorized()) {
        
        shiny::div(class = "blockAppDiv")
                    ...
                    userBox(
                      ...
                      fluidRow(
                        ...
                        box(title = tags$strong("Riferimenti"), width = 6, collapsible = F, collapsed = F, status = "info", solidHeader = FALSE,
                            ...
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("Il grafo stradale deriva dalla simulazioni dei flussi di traffico del ", tags$a("modello regionale dei trasporti",href="https://mobilita.regione.emilia-romagna.it/pianificazione/modellazione-dei-trasporti",target = "_blank"), " per l'anno 2023."))),
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("La distribuzione temporale dei flussi è stata effettuata utilizzando i dati del ", tags$a("sistema di monitoraggio regionale",href="https://mobilita.regione.emilia-romagna.it/pianificazione/monitoraggio-del-sistema-di-mobilita",target = "_blank"), " per l'anno 2023."))),
                            
                            tags$li(tags$span(style="text-align: justify;",HTML(paste0(tags$strong("Parco veicoli regionale", style="color: #17a2b8;"))),tags$br())),
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("La distribuzione del parco veicolare circolante è stata estratta dai ", tags$a("dati ACI",href="https://www.aci.it/laci/studi-e-ricerche/dati-e-statistiche/autoritratto/autoritratto-2023.html",target = "_blank"), " per l'anno 2023."))),
                            ...
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("Il numero dei cittadini residenti a livello comunale deriva dai ", tags$a("dati demografici ISTAT",href="https://demo.istat.it/",target = "_blank"), " per l'anno 2023."))),
                            
                            tags$li(tags$span(style="text-align: justify;",HTML(paste0(tags$strong("Emissioni", style="color: #17a2b8;"))),tags$br())),
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("Il calcolo delle emissioni è stato effettuato secondo la ", tags$a("metodologia INEMAR.",href="https://www.inemar.eu/xwiki/bin/view/InemarWiki/",target = "_blank")))),
                            
                            tags$li(tags$span(style="text-align: justify;",HTML(paste0(tags$strong("Concentrazioni", style="color: #17a2b8;"))),tags$br())),
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("La stima delle concentrazioni utilizza la metodologia di calcolo derivante dal ", tags$a("progetto SHERPA del JRC.",href="https://academy.europa.eu/courses/sherpa-a-tool-to-support-the-design-of-urban-regional-air-quality-plans",target = "_blank")))),
                            tags$div(style="text-align: justify; margin-left: 20px;",HTML(paste0("Le funzioni sorgente/recettore sono state addestrate da ARPAE per la definizione degli scenari del ", tags$a("PAIR 2030.",href="https://ambiente.regione.emilia-romagna.it/it/aria/pair-2030",target = "_blank")))),
                      ...
                      fluidRow(
                        ...
                        column(width = 12, align = "center", HTML(paste0(a(img(src='lepida_logo_viola.svg',height='35'),href="https://www.lepida.net/",target = "_blank",id = "logo1"), "&nbsp;", "&nbsp;",
                                                                         a(img(src='ARPAE.svg',height='35'),href="https://www.arpae.it/it",target = "_blank",id = "logo2"), "&nbsp;", "&nbsp;",
                                                                         a(img(src='logo_RER.jpg',height='35'),href="https://www.regione.emilia-romagna.it/",target = "_blank",id = "logo3")))),
                        ...
                        column(width = 12, align = "center", HTML(paste0(a(img(src='logo_Terraria_Ridimensionato.png',height='35'),href="https://www.terraria.com",target = "_blank",id = "logo4"))))
